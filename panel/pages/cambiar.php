            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form class="user" action="../backend/crud/actualizar_contra.php" method="POST">

                                <div class="form-group justify-content-center row ">

                                    <div class="col-sm-2 ">
                                        <label>Nueva Contraseña: </label>
                                        <input type="password" class="form-control form-control-user" id="password_usuario" name="pass_nueva" value="" placeholder="*************" onkeyup="check();" required>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 text-right">
                                        <a href="dashboard.php" class="btn btn-danger btn-icon-split">
