...
<head>
    ...
    <title>Nuevo usuario - Ay Que Perros</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form class="user" action="../backend/crud/crear_usuario.php" method="POST">
                                <div class="form-group row">

                                    <div class="col-sm-4 mb-3">
                                        <label>Nombre: </label>
                                        <input type="text" class="form-control form-control-user" name="nombre" value="" placeholder="Eduardo" required>
                                    </div>

                                    <div class="col-sm-4 mb-3">
                                        <label>Apellido paterno: </label>
                                        <input type="text" class="form-control form-control-user" name="ap_paterno" value="" placeholder="Salazar" required>
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                        <label>Apellido materno: </label>
                                        <input type="text" class="form-control form-control-user" name="ap_materno" value="" placeholder="Tecuapacho" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="email" class="form-control form-control-user" name="email_usuario" value="" placeholder="nombre@gmail.com" required>
                                    </div>
                                    <div class="col-sm-2">
                                        <label>Contraseña: </label>
                                        <input type="password" class="form-control form-control-user" id="password_usuario" name="password_usuario" value="" placeholder="*************" onkeyup="check();" required>
                                    </div>
                                    <div class="col-sm-2">
                                        <label>Confirmar contraseña: </label>
                                        <input type="password" class="form-control form-control-user" id="confirm_password_usuario" name="confirm_password_usuario" value="" placeholder="*************" onkeyup="check();" required>
                                    </div>
                                </div>
