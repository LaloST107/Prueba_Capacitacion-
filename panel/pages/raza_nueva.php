            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-whte-600 small"><?php echo $_SESSION['usuario_nombre_completo']; ?></span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Registrar Nueva Raza</h1>
                    </div>
                    <div class="card shadow mb-4">
                        <div class="card-body">

                            <form class="user" action="../backend/crud/crear_razas.php" method="POST">
                                <div class="form-group row">
                                    <div class="col-sm-4 mb-3">
                                        <!-- valores para el formulario -->
                                        <label>Nombre de la Raza: </label>
                                        <input type="text" class="form-control form-control-user" name="raza" value="" placeholder="husky" required>
                                    </div>

                                    <div class="col-sm-4 mb-3">
                                        <label>Enfermedades: </label>
                                        <input type="text" class="form-control form-control-user" name="enfermedad_perro" value="" placeholder="Cataratas" required>

                                    </div>
                                    <div class="col-sm-4 mb-3">
                                        <label>Criado: </label>
                                        <input type="text" class="form-control form-control-user" name="criado_perro" value="" placeholder="Perro de trineo" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-2 mb-3">
                                        ...
                                        <select class="form-control" name="orejas_perro" required>
                                            <option value="L">Largas</option>
                                            <option value="C">Cortas</option>
                                        </select>
                                    </div>
<!-- Aqui se me quede en editar -->
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control form-control-user"  name="pais_perro" value="" placeholder="Siberia"  required>
                                    </div>

                                    <div class="col-sm-3">
                                        <label>Descendencia: </label>
                                        <input type="text" class="form-control form-control-user"  name="descendencia_perro" value="" placeholder="Eskimo"  required>
                                    </div>
                                    <!-- Colocar cantidad de razas  el name es con el que se recupera los datos-->
                                    <div class="col-sm-3">
                                        <label>Cantidad de Perros: </label>
                                        <input type="number" min="0" class="form-control form-control-user"  name="num_raza" value="" placeholder="5"  required>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 text-left">
                                        <button type="submit" class="btn btn-info btn-icon-split" id="btn-registrar">
                                            ...
                                            <span class="text">Registrar raza</span>
                                        </a>
                                    </div>
                                </div>
                            </form>
