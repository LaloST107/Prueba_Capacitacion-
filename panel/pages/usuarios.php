<?php
    ...
    if(!isset($_SESSION['usuario_id'])){
        ...
        if($_SESSION['usuario_rol'] != 1){
            ...
            $query_text = 'SELECT * FROM usuarios;';
                ...
                <!-- Begin Page Content -->
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12 text-left">
                            <a href="usuario_nuevo.php" class="btn btn-info btn-icon-split">
                        ...
                        <div class="col-md-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h4 class="m-0 font-weight-bold text-primary text-center">Tabla de usuarios</h4>
                                </div>
                                <!-- cardy body -->
                                <div class="card-body">
